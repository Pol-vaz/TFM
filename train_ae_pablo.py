...
if __name__ == "__main__":
    ...
    if do_train:
        ...
        num_epochs = 3
        input('\npulsa...')
        history = autoencoder.fit_generator(fitting_generator, steps_per_epoch=steps, epochs=3, verbose=1,
                                          callbacks=callbacks, validation_data=valid_generator, validation_steps=5)
        ...
        # Guardar modelo entrenado
        autoencoder.save_weights('trained_models/{}_weights_median_new.h5'.format(experiment_label))
