...
if __name__ == "__main__":
    ...
    base_image = 'median_image.png'  # 'cenital2.png' #'median_image.png'
    object_images = ['circle-red.png', 'robo-green.png']  # circle in the first place, as robo can be drawn over it

    # default config
    img_dim = 32  # Relacionado con im_shape que se carga despues
    img_shape = (img_dim, img_dim, 1)  # Se carga despues
    num_epochs = 10  # Se carga despues
    batch_size = 32  # Se carga despues
    latent_size = 16  # 25, 36, 49, 64   # Se carga despues
    conv_layers = 3  # Se carga despues
    loss = 'mse'  # bin-xent' #'mse' #   #  # Se carga despues
    opt = 'adadelta'  # 'adam' # #  # Se carga despues
    model_label = 'ae_v2'  # Se carga despues
    do_train = False  # Se carga despues
    do_test = True  # Se carga despues
    interactive = True  # Se carga despues
    num_filters = 3  # Se carga despues
    kernel_size = 3  # Se carga despues
    kernel_mult = 1  # Se carga despues
