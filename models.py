...
def make_forward_model_3_layers(latent_size, action_size=1, learn_only_difference=False, activation_fun = 'sigmoid'):
    ...
    x = merged
    x = Dense(dense_size, kernel_initializer=normal, kernel_regularizer=kernel_regularizer, bias_initializer='ones', activation= activation_fun)(x)
    #x = Dropout(0.2)(x)
...
def make_forward_model_5_layers(latent_size, action_size=1, learn_only_difference=False, activation_fun = 'relu'):
...
def make_forward_model_10_layers(latent_size, action_size=1, learn_only_difference=False, activation_fun = 'relu'):
